    ...
    return (
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div className="flex items-center mb-4">
          <Link
            to={`/pools/${encodeURIComponent(decodedPoolName)}`}
            className="mr-2"
          >
        ...
        <div className="p-6 bg-background rounded-lg border shadow-sm">
          ...
          <div>
            ...
            <p>Pool: {decodedPoolName}</p>
          </div>
          <div className="mt-6">
            <Button asChild>
              <Link to={`/pools/${encodeURIComponent(decodedPoolName)}`}>
                Return to Pool
              </Link>
            </Button>
          </div>
            ...
            <div className="flex justify-between items-start">
              <div>
                <CardTitle className="flex items-center">
                  {worker.name}
                  <span className="ml-2">{getStatusBadge(worker.status)}</span>
                </CardTitle>
                <CardDescription>
